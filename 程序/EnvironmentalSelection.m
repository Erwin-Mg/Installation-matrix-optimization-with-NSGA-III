function Population = EnvironmentalSelection(Population,N,Z,Zmin,robotArm,R_BA1,Jacob,endlocation,W,MF)
global PopCon 
...
%--------------------------------------------------------------------------
    ...
    Population_objs = CalObj(Population,robotArm,R_BA1,Jacob,endlocation,W,MF);
